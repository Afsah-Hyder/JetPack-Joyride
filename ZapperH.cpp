...
void Zapper_h::animation(){
    if (frame==1*frame_speed){
        src = {21,452, 179, 55};         //selecting the image from asset file
        // SDL_Delay(40);
        // frames++;
    }

    else if (frame==2*frame_speed){
        src = {18,531, 185, 56};        //selecting the image from asset file
        // SDL_Delay(40);
        // frame=0;
    }

    else if (frame==3*frame_speed){
        src = {772,452, 179, 55};       //selecting the image from asset file
        // SDL_Delay(40);
        // frame=0;
    }

    else if (frame==4*frame_speed){
        src = {772,531, 179, 53};       //selecting the image from asset file
        // SDL_Delay(40);
